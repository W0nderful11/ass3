document.addEventListener('DOMContentLoaded', () => {
    ...
    function calculatePrice() {
        ...
        let caste = document.querySelector('select#caste').value;
        ...
        let ageCoeff = 1;
        if (age) {
            if (age.value === '18-23') ageCoeff = 1.5;
            else if (age.value === '24-27') ageCoeff = 1.2;
            else if (age.value === '28+') ageCoeff = 0.95;
        }
